                ...
                .done(function(response){
                    $('.wishlist-table').each(function(){
                        ...
                        $.each(response,function(index,object){
                            $this.append('<tr data-product="'+object.id+'"><td style="width:75%!important;font-weight: 700!important;"><a class="wishlist-remove" style="width:20px!important;height:20px!important;" href="#" title="'+opt.removeWishlist+'"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+object.title["rendered"]+'</td><td style="width:15%!important;font-weight: 700!important;">£'+object.price+'</td><td style="width:10%!important;"><a class="btn btn-wl" href="'+object.link+'"><i class="fas fa-eye"></i></a></td></tr>');
                        });
                    });
                })
