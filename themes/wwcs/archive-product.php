                ...
                <div class="row" style="margin-left:0!important;margin-right:0!important;">
                    ...
                    foreach ($product_data as $product_id) {
                        ...
                        if (!in_array($product_id, $cust_history)) {
                            ?>
                            <div style="margin-bottom: 10px;padding-left:2.5%!important;" class="col-md-3 text-center"
                                 id="<?php echo $product_id ?>">

                                <div class="inner-prod"
                                     style="width:90%!important;padding-bottom:35px;position:relative;min-height:23em;">

                                    <div class="w-100" style="min-height: 40px;">
                                        <?php
                                        if ($fitness_track == true) { ?>
                                            <p class="float-left"
                                               style="color:#fff!important;font-size:12px;padding:3px;background-color: #000000;">
                                                <i class="fas fa-burn"
                                                   style="color: #ffa600;font-size:16px!important;"></i>&nbsp;fitness
                                                track</p>
                                            <?php
                                        }
                                    ...
                                    <div class="w-100" style="padding-left: 15px;padding-bottom:25px;">
                                        <div title="choreographer"
                                             style="font-family: 'PT Sans', sans-serif!important;display: inline!important;float:left!important;font-size:18px!important;font-weight: 700!important;">
                                            <div class="test rounded-circle float-left"
                                                 style="width:35px;height:35px;background-color: #000000;margin:0!important;padding-top:2px;padding-right:2px;">
                                                <img src="/wp-content/uploads/2021/10/dancer-2-e1622667179728-1-e1637930243563.png"
                                                     style="width:20px!important;" alt="dancer icon">&nbsp;
                                            </div>
                                            <p class="float-left"
                                               style="font-family: 'PT Sans', sans-serif!important;font-size:16px;font-weight: 700;">
                                                <?php
                                                if ($choreographers) {
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 text-center"
                                             style="padding-right:35px;position:absolute;bottom:0;">
                                            <h2 class="woocommerce-loop-product__title float-right"
                                                style="width:20%;color:#1d003b;">£<?php echo $price ?></h2>
                                            <a href="<?php echo $link ?>" class="button product_type_simple text-center"
                                               style="margin-left:3px;background-color: #3b0093!important;width:33%!important;float:left;font-size:15px;"><i
