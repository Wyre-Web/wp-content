    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="woocommerce-cart-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
                    ...
                    <!--Section: Block Content-->
                        ...
                        ?>
                        <!--Grid row-->
                        <div style="margin-left:0!important;margin-right: 0!important;" class="row woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5 col-lg-3 col-xl-3">
                                                <div class="text-center p-1" style="background-color:#1b1b1b!important;">
                                                    ...
                                                    <p style="font-size: 11px;color:#fff!important;"><strong><?php echo $product_name; ?></strong></p>

                                                    <p style="font-size: 11px;margin-top:-10px;color:#1b1b1b!important;"></p>
                                            ...
                                            <div class="col-md-7 col-lg-9 col-xl-9">
                                                <div>
                                                    ...
                                                    <div class="justify-content-between w-100">
                                                        <div class="row">
                                                            <div class="col-8">
                                                                <p class="font-weight-bold" style="font-size: 18px;color:#1b1b1b!important;"><?php echo $product_name; ?> </p>
                                                            </div>
                                                            <div class="col-4">
                                                            ...
                                                            <div class="col-12" style="margin-top:-5px;">
                                                                <p style="font-size: 11px;color:#1b1b1b!important;"><strong><?php echo the_field('stage_screen', $product_id) ?> &bull;&nbsp;Choreographer:<?php echo $choreographer_name ?></strong></p>
                                                                <p class="mb-2 font-weight-bold text-uppercase small" style="color:#1b1b1b!important;">Panache Dance Fitness Streamed Content                           <?php
            ...
            <div class="modal-footer w-100">
                ...
                <a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="btn text-white" style="background-color:#00ce74!important;border:0!important;font-weight: bold!important;">
                    <?php esc_html_e( 'Checkout now', 'woocommerce' ); ?> <img src="/wp-content/uploads/2021/09/checkout-24.png" alt="checkout icon">
                </a>
                </div>
                </div>
            </div>
