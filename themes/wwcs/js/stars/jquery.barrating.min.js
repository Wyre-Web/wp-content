    ...
    var e = function () {
        function e() {
            var e = this,
                ...
                a = function (n) {
                    return t.isNumeric(n) && (n = Math.floor(n)), t('radio[value="' + n + '"]', e.$elem)
                },
                r = function () {
                    var n = e.options.initialRating;
                    return n ? a(n) : t("radio:selected", e.$elem)
                },
                o = function () {
                    var n = e.$elem.find('radio[value="' + e.options.emptyValue + '"]');
                    return !n.length && e.options.allowEmpty ? (n = t("<radio />", {
                ...
                g = function () {
                    ...
                    return e.$elem.find("radio").each(function () {
                        var i, a, r, o;
                ...
                m = function () {
                    t("radio", e.$elem).prop("selected", function () {
            ...
            this.show = function () {
                ...
                var n = l("userOptions");
                0 !== e.$elem.find('radio[value="' + t + '"]').length && (s("ratingValue", t), s("ratingText", e.$elem.find('radio[value="' + t + '"]').text()), s("ratingMade", !0), h(f()), v(c()), w(), n.silent || n.onSelect.call(this, f(), c()))
            }, this.clear = function () {
                var t = l("userOptions");
