        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-6 text-center">
                    ...
                    <button type="button" class="btn btn-favourites" data-toggle="modal" data-target="#favouritesModal"
                        style="width:80%;border-radius:0;padding:4px!important;">
                        View my favourites &nbsp;&nbsp;<i class="far fa-heart" style="font-weight: 900;color:#fff;"></i>
                    </button>
                </div>
                <div class="col-6 text-center">
                    <a href="/choreography-store" class="btn"
                        style="background-color: #fff;color:#1b1b1b!important;font-weight: 700!important;width:80%;padding:4px;border-radius:0;">Go
                        to choreography store &nbsp;&nbsp;<i style="font-weight: 900;"
...
foreach($wc_products as $product_id) {
   ...
   if(in_array($product_id, $cust_history)) { ?>
                <div class="col-md-3 " style="margin-bottom:10px;">
                    <div class="inner-prod text-center" style="position:relative;min-height:12em;">
              ...
              echo '<span class="wishlist-title float-right">' . esc_attr__("Add to favourites", "text-domain") . '</span><a class="wishlist-toggle" style="position:absolute;right:0;padding-right:5px!important;margin:0!important;" data-product="' . esc_attr($product_id) . '" href="#" title="' . esc_attr__("Add to wishlist", "text-domain") . '"><i style="font-size:20px;color:#2b2b2b;opacity: 0.6;" class="far fa-heart"></i></a>';
               ?>
                        ...
                        <h5 style="color:white;padding-left:10px;padding-top:10px"><?php echo $title ?></h5>

                        <div class="prod-fields text-center"
                            style="padding-left:10px;border-top: 2px solid #0286be;padding-top: .5em;">
                            <?php
                foreach ($tags as $tag) {
                    echo '<p style="font-size: 14px!important;color:rgba(255,255,255,0.8)">'.$tag->name.'</p>';
                }
                ?>
                            <p style="font-size: 16px;"> <img class="dance-icon"
                                    src="https://panache.nic-edesign.com/wp-content/uploads/2021/10/dancer-2-e1622667179728-1-e1637930243563.png"
                                    style="width:25px!important;" alt="dancer icon">&nbsp;
                                <?php
                     if($choreographers) {
                     ...
                     ?>
                        ...
                        <a href="<?php echo $link ?>" class="btn btn-watch"
                            style="bottom:0;width:100%;padding:5px;font-weight: 700;border-radius:0!important;">Watch
