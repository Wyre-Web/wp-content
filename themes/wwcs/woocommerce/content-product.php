...
if(!in_array(get_the_id(), $cust_history)) {
?>

            <div style="margin-bottom: 10px;padding-left:2.5%!important;" class="col-md-3 text-center" id="<?php echo $product_id ?>">

                <div class="inner-prod" style="width:90%!important;background-color: rgba(26,26,26,0.8);padding-bottom:35px;position:relative;min-height:24em;">
                    <?php


                    ?>

                    <div class="w-100" style="min-height: 40px;padding-left: 15px;">
...
?>
	...
	do_action('woocommerce_after_shop_loop_item_title','woocommerce_template_loop_price');
